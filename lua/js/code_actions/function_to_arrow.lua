    ...
    return {
        ...
        generator = {
            fn = function(params)
                ...
                local can_convert, function_node = regular_function.can_convert_to_arrow(bufnr, row, col)
                ...
                return {
                    {
                        ...
                        action = function()
                            local edit = regular_function.create_arrow_conversion_edit(function_node, bufnr)
